...
class Lab1ApplicationTests {
    ...
    @Autowired // This will allow Spring to inject CalculateCost when creating the test class
    public Lab1ApplicationTests(CalculateCost calculateCost) {
        this.calculateCost = calculateCost;
    }
    @Test
    void calculateCostBeanIsNotNull() {
    ...
    void costCalculatesCorrectly() throws Exception {
        assert calculateCost.calculateWeddingCostExVat("RS342") == 360; //VALUE HANGED FROM 360
